...
#define LOG_TAG "PNSDemo"
#define LOGI(...) ((void)__android_log_print(ANDROID_LOG_INFO, "PNSDemo", __VA_ARGS__))
#define LOOPER_ID 1
...
//void Java_itri_pns_PNSDemo_sensorValue( JNIEnv* env, jobject thiz ) {
